							...
							<input type="hidden" name="sid" value="<?php echo $sid;?>">
								<div class="col-md-6">
									...
									<div class="form-group">
										<input class="form-control" id="PrimaryName" name="PrimaryName" type="text" placeholder="Primary Contact Name" pattern="([A-Za-z]+)( )*([A-Za-z]*)" value="<?php echo $healthArray["Pname"];?>" disabled>
									</div>
									<div class="form-group">
										<input class="form-control" id="PrimaryNum" name="PrimaryNum" type="text" placeholder="Phone Number"  pattern="[(]([0-9]{3})[)]([0-9]{3})-([0-9]{4})" value="<?php echo $healthArray["Pphone"];?>" disabled>
									</div>
									<div class="form-group">
										<input class="form-control" id="PrimaryRel" name="PrimaryRel" type="text" placeholder="Relationship" pattern="([A-Za-z]+)( )*([A-Za-z]*)" value="<?php echo $healthArray["Prel"];?>" disabled>
									</div>
								</div>
								<div class="col-md-6">
									<p> <b>Secondary Contact: </b></p>
									<div class="form-group">
										<input class="form-control" id="SecondaryName" name="SecondaryName" type="text" placeholder="Secondary Contact Name" pattern="([A-Za-z]+)( )*([A-Za-z]*)" value="<?php echo $healthArray["Sname"];?>" disabled>
									</div>
									<div class="form-group">
										<input class="form-control" id="SecondaryNum" name="SecondaryNum" type="text" placeholder="Phone Number" pattern="[(]([0-9]{3})[)]([0-9]{3})-([0-9]{4})" value="<?php echo $healthArray["Sphone"];?>" disabled>
									</div>
									<div class="form-group">
										<input class="form-control" id="SecondaryRel" name="SecondaryRel" type="text" placeholder="Relationship" pattern="([A-Za-z]+)( )*([A-Za-z]*)" value="<?php echo $healthArray["Srel"];?>" disabled>
									</div>
								</div>
